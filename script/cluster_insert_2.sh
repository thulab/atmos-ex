...
test_operation() {
	...
	for ((j = 1; j <= 5; j++)); do
		...
		ssh ${ACCOUNT}@${D_IP_list[${j}]} "sudo cp -rf $${TEST_DATANODE_PATH}/dn_dump.hprof ${BUCKUP_PATH}/${ts_type}/${commit_date_time}_${commit_id}_${data_type}_${protocol_class}/${j}/DN/"
	done
