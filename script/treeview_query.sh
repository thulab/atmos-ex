...
IOTDB_PW="${TREEVIEW_IOTDB_PW:-root}"
...
MYSQLHOSTNAME="${TREEVIEW_MYSQL_HOSTNAME:-111.200.37.158}"
PORT="${TREEVIEW_MYSQL_PORT:-13306}"
USERNAME="${TREEVIEW_MYSQL_USERNAME:-iotdbatm}"
